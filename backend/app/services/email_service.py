...
# ---- Brand tokens (kept in sync with frontend/src/styles/tokens.css) ----
BRAND_900 = "#0E2E28"
BRAND_700 = "#1F5D50"
BRAND_600 = "#256B5C"
BRAND_050 = "#F1F7F5"
...
def _logo_svg() -> str:
    """Inline SVG mirroring the app's SealLogo component, base64'd as a data URI
    so it renders reliably across email clients without hosting an image."""
    return (
...
def _base_template(preheader: str, body_html: str, footer_note: str = "") -> str:
    """Shared shell used by every transactional email: header with logo/brand,
    a white content card, and a standard footer — same structure real companies
    (Stripe, Uber, Linear, etc.) use for transactional mail."""
